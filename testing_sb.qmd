...
```{python}
# Check if betweenness centrality is stored as edge attributes in G
print("Checking edge attributes in graph G:")
print()

# Get first edge with all its attributes
for u, v, k, data in G.edges(keys=True, data=True):
    print(f"Edge {u}→{v} (key={k}): {data}")
    break  # Just show first edge

print()
print("Available edge attributes:")
sample_edge = list(G.edges(keys=True, data=True))[0]
print(sample_edge[3].keys())
```
